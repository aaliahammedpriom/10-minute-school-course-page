        ...
        <div className="navbar lg:px-[7vw] bg-base-100 shadow-sm">
            <div className="navbar-start">
                <div className="dropdown">
                    <div tabIndex={0} role="button" className="btn btn-ghost xl:hidden p-0">
                    ...
                    <ul
                        ...
                        <li><a>Online Batch</a></li>
                        <li><a>English Center</a></li>
                        <li><a>More</a></li>
                    </ul>
                </div>
                <img className="btn btn-ghost text-xl py-0 " src="https://cdn.10minuteschool.com/images/svg/10mslogo-svg.svg" alt="" />
            </div>
            <div className="navbar-center flex justify-between gap-4 max-md:hidden">
                <div className="flex items-center bg-white border border-gray-300 rounded-full px-4 py-2 w-full max-w-xl shadow-sm">
                    <div className="w-6 h-6 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="24" fill="none" viewBox="0 0 27 24">
                            ...
                            <path fill="#111827" d="M21.247 20.065l-2.83-2.82a6.59 6.59 0 001.407-4.078 6.657 6.657 0 10-6.657 6.657 6.59 6.59 0 004.077-1.407l2.82 2.83a.834.834 0 001.365-.271.833.833 0 00-.182-.911zM8.174 13.167a4.993 4.993 0 119.985 0 4.993 4.993 0 01-9.985 0z" />
                ...
                <div className="navbar-center flex max-xl:hidden ">
